...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;500;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{% static 'css/styles-tutor-new.css' %}">
  <title>Tutor</title>
...
<body>
  ...
  <div class="navbar">
    <div class="topnav" id="myTopnav">
      <a href="/" class="active"><img src="{% static 'images/assets-tutor-new/logo.png' %}"></a>
      ...
      <a style="color: white; text-decoration: none; padding: 6px 0px;" href="/tutor/register/" id="url"><button class="button1" style="vertical-align:middle; width: 130px;"><span>Sign Up </span></button></a>
  ...
  <div class="landing">
    <div class="slide-in landing-left">
      ...
      <center>
        <img class="tutor-image" src="{% static 'images/assets-tutor-new/landing.svg' %}">
      </center>
    ...
    <div class="features">
      <div class="feature1">
        <center><img class="feature-image" src="{% static 'images/assets-tutor-new/feature1.svg' %}"></center>
        <p class="feature-text">100% Genuine Website</p>
      </div>
      <div class="feature2">
        <center><img class="feature-image" src="{% static 'images/assets-tutor-new/feature2.svg' %}"></center>
        <p class="feature-text">Simplest Registration Process</p>
      </div>
      <div class="feature3">
        <center><img class="feature-image" src="{% static 'images/assets-tutor-new/feature3.svg' %}"></center>
  ...
  <div class="intro" id="intro">
    ...
    <img class="decoration" src="{% static 'images/assets-tutor-new/design.png' %}">
  </div>
...
<script>
  ...
  <div class="work" id="work">
    ...
    <div class="fade work-grid">
      <div class="deadline">
        <center><img src="/static/images/assets-tutor-new/deadline.jpg" alt="" class="deadline-image"></center>
      ...
      <div class="live-sesson">
        <center><img src="/static/images/assets-tutor-new/live.jpeg" alt="" class="live-session-image"></center>
      ...
      <p class="primary-heading">Testimonials</p>
        ...
        <div class="fade testimonial-box">
          <div id="slide">
            ...
            <div class="card">
              <div class="profile">
                <img class="tutor-testimonial-image" src="/static/images/assets-tutor-new/tutor1.jpg">
            ...
            <div class="card">
              <div class="profile">
                <img class="tutor-testimonial-image" src="/static/images/assets-tutor-new/tutor2.jpg">
                <div class="profile-text">
            ...
            <div class="card">
              <div class="profile">
                <img class="tutor-testimonial-image" src="/static/images/assets-tutor-new/tutor3.jpg">
                <div class="profile-text">
            ...
            <div class="card">
              <div class="profile">
                <img class="tutor-testimonial-image" src="/static/images/assets-tutor-new/tutor4.jpg">
                <div class="profile-text">
            ...
            <div class="card">
              <div class="profile">
                <img class="tutor-testimonial-image" src="/static/images/assets-tutor-new/tutor5.jpg">
                <div class="profile-text">
          ...
          <div class="sidebar">
            <img src="/static/images/assets-tutor-new/up.png" id="up">
            <img src="/static/images/assets-tutor-new/down.png" id="down">
          </div>
    ...
    <div class="faqs" id="faqs">
      ...
      <div class="fade faq-grid">
        <div class="faq-left">
          ...
          <img class="faq-image" src="{% static 'images/assets-tutor-new/faqs.svg' %}">
        </div>
        <div class="faq-right">
          <div class="faq">
    ...
    <div class="footer fade">
      <div class="footer-grid">
        <div class="apply">
          <div class="logo"><img src="{% static 'images/assets-tutor-new/logo.png' %}"></div>
