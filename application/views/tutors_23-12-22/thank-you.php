...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NVND638"
            ...
            <div class="header-upper">
                <div class="auto-container clearfix">
                    <div class="pull-left logo-box">
                        <div class="logo"><a href="/tutor/"><img src="{% static 'images/logo.png' %}" alt="" title=""></a>
                        </div>
                    </div>
                </div>
            </div>
	...
	<div class="page-wrapper news-section">
		<section id="counter-stats" style="display: inline-block; width: 100%;">
			<div class="pattern-layer-seven" style="background-image: url('/static/images/main-slider/pattern-5.png')"></div>
			<div class="icon-layer-two" style="background-image:url('/static/images/icons/icon-2.png')"></div>
				...
				<div class="row">
                    <div class="col-12">
                        ...
                        <div class="thankYou">
                            ...
                            <a href="/tutor/" style="position: relative; z-index: 999; text-decoration: none; display: block; text-align: center;">Go To Home Page</a>
						</div>
