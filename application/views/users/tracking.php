					...
					<form class="order_form" action="" method="post" enctype="multipart/form-data">
						...
						<div class="first_step opened_Box" style="display:block;">
							<div class="form_head">
								...
								<h3>
									<?php echo $order[0]['order_id']; ?> - Cost Accounting <input type="button" id="next"
										class=" toogelBtn" value=""><i class="fa fa-chevron-down"></i>
								</h3>
							</div>
							<div class="form_innBox">
								<div class="form_fields">
									...
									<textarea class="textarea" name="description" id="description"
										placeholder="Description"><?php echo $order[0]['description']; ?> </textarea>
								</div>
								<div class="form_fields">
									<label>Question Files</label>
									<div class="upload_MFile">
										<span class="fileinput-button" id="fileinput-button">
											<span><i class="fas fa-cloud-upload-alt"
													aria-hidden="true"></i><br><span>Drop your file or Browse</span>
											</span>
								...
								<div class="form_fields">
									...
									<div class="deadline_con">
										...
										<input class="input" type="datetime-local"
											value="<?php echo date('Y-m-d\TH:i:s', strtotime($order[0]['deadline'])); ?>"
											name="deadline">
									</div>
								</div>
								<div class="form_fields">
									...
									<div class="upload_MFile">
										<span class="fileinput-button" id="fileinput-button">
											...
											<input type="file" name="refFiles" id="files" multiple
												accept="image/jpeg, image/png, image/gif,"><br />
										</span>
						...
						<div class="Availability_step" style="display:block;">
							<div class="form_head">
								<span class="pending_step"></span>
								<i style="display: none;" class="completed_step fa fa-check"></i>
								<h3>Checking Tutor Availability <i class="fa fa-chevron-down"></i> <input type="button"
										id="availability_stepNext_btn" class="toogelBtn" value=""></h3>
							</div>
							<div class="form_innBox">
								<div class="assignmentProgressBox">
									<h4>
										<div class="assignmentProgress"></div>We Checking Tutor Availability
									</h4>
								...
								<div class="assignmSolve">
									<div>
										...
										<p>Please download the solution. If you have any queries regarding the solution,
											please let us know through chat.</p>
									</div>
									<div>
						...
						<div class="Second_step" style="display:block;">
							<div class="form_head">
								<span class="pending_step"></span>
								<i style="display: none;" class="completed_step fa fa-check"></i>
								<h3>Payments <i class="fa fa-chevron-down"></i> <input type="button"
										id="second_stepNext_btn" class="toogelBtn" value=""></h3>
							</div>
							<div class="form_innBox">
								<div class="paymentInnBox">
									<h4>Make the Payment</h4>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do consectetur
										adipisicing elit, sed do eiusmod. </p>

								</div>
								<div class="payment_done">
									<h4><i class="fas fa-check-circle"></i> Payment</h4>
									<p>Your payment has been received. Tutors have initiated the work on your
										assignment.</p>
								</div>
							</div>
						</div>
						<div class="third_step" style="display:block;">
							<div class="form_head">
								<span class="pending_step"></span>
								<i style="display: none;" class="completed_step fa fa-check"></i>
								<h3>Assignment In Progress <i class="fa fa-chevron-down"></i> <input type="button"
										id="third_stepNext_btn" class="toogelBtn" value=""></h3>
							</div>
							<div class="form_innBox">
								<div class="assignmentProgressBox">
									<h4>
										<div class="assignmentProgress"></div> Assignment in Progress
									</h4>
									<p>Your payment has been received. Tutors have initiated the work on your
										assignment.</p>
								</div>
						...
						<div class="four_step" style="display:block;">
							<div class="form_head">
								<span class="pending_step"></span>
								<i style="display: none;" class="completed_step fa fa-check"></i>
								<h3>Rate & Feedback <i class="fa fa-chevron-down"></i> <input type="button"
										id="FeedbackToggle" class="toogelBtn" value=""></h3>
							</div>

							<div class="form_innBox">
								<h4>Rate us now</h4>
								<p>Thank you for taking help from us. Please write feedback that will help to improve
									our process.</p>
