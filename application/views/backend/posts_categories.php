...
function get_category_list()
{
    ...
    $.ajax({
        type        : 'GET',
        url         : "<?php echo base_url(BACKEND_FOLDER.'/blog-posts/categories?get_list=1');?>",
        dataType    : 'json',
...
function get_category_by_id(id)
{
    $.ajax({
        type        : 'GET',
        url         : "<?php echo base_url(BACKEND_FOLDER.'/blog-posts/categories/');?>"+id+"?get_list=1",
        dataType    : 'json',
        success     : function(response)
        {   
            var id  = response.id;
...
function validate_category()
{
    ...
    else
    {
        ...
        $.ajax({
            type        : 'POST',
            url         : "<?php echo base_url(BACKEND_FOLDER.'/blog-posts/add-categories');?>",
             data       : form_data,
            contentType : false,
            cache       : false,
            processData : false,
