...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@100;300;400;500;700;900&amp;display=swap"
    rel="stylesheet">
  <link rel="shortcut icon" href="http://localhost/tutorchamps/assets/front/images/fav.png" type="image/x-icon">
  ...
  <div class="big_container2">
    ...
    <div class="first2">
      ...
      <div class="ins-div">
        <div class="ins-div-2">
          ...
          <div style="margin-left: 10%;">
            <ul>
              <li class="instructions"><?php echo $attempted;?></li>
              <li class="instructions"><?php echo $correct;?></li>
              <li class="instructions"><?php echo $Marks;?>% </li>
              <li class="instructions">
                <div style="color: red; display: inline-block" id="status"><?php echo $status;?><div>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="text-center psr mt-3">
        ...
        <button class="button" style="vertical-align:middle"><span><a href="<?php echo base_url();?>tutor/" id="url">Go To Home</a> </span></button>
      </div>
    ...
    <script>
      ...
      if (newStatus == "Pass") {
        ...
        $("#url").prop('href','<?php echo base_url();?>tutor/dashboard/')
