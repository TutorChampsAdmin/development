      ...
      <div class="ins-div">
        <div class="ins-div-2">
          <ul>
            ...
            <li class="instructions"><b>Total Wrong Answers:</b></li>
            <li class="instructions"><b>Total Marks:</b></li>
            <li class="instructions"><b>Status:</b></li>
          </ul>
          <div style="margin-left: 10%;">
            <ul>
              <li class="instructions">8</li>
              <li class="instructions">3</li>
              <li class="instructions">35</li>
              <li class="instructions">
                <div style="color: red; display: inline-block" id="status">Failed<div>
              </li>
            </ul>
          </div>
        </div>
